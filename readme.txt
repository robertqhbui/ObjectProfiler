...
Build
======
You can build open the Visual Studio solution or project using Visual Studio 2017 or later, with C++11.
...
As this is an example, I have no included unit tests.